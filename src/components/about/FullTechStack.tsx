...
export function FullTechStack() {
  ...
  return (
    <section id="tech-stack" className="py-24 md:py-32 bg-surface-elevated/10 scroll-mt-20 md:scroll-mt-24">
      <Container>
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col gap-12 md:gap-16 mt-4">
            {TECH_CATEGORIES.map((category) => (
              <div
                key={category.title}
                className="flex flex-col md:flex-row gap-6 md:gap-12 items-start border-t border-border/40 pt-8 first:border-0 first:pt-0"
              >
                ...
                <div className="flex flex-wrap gap-4 w-full">
                  {category.items.map((tech, i) => {
                    ...
                    return (
                      ...
                      >
                        <Icon
                          className={`w-5 h-5 text-foreground-muted transition-colors duration-300 ${tech.color}`}
                        />

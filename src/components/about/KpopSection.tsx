      ...
      <Container>
        ...
        >
          ...
          <div className="flex flex-col gap-8 md:gap-10 pt-12 border-t border-border/40 relative w-full">
            {/* Playful elements */}
            <div className="absolute top-0 right-10 -translate-y-1/2 opacity-30 hidden md:block text-accent-blue rotate-12">
              ...
              {kpopInterests.map((interest, i) => (
                ...
                >
                  <div className="w-full aspect-3/2 overflow-hidden rounded-3xl bg-surface-elevated/20 shadow-[0_4px_20px_rgba(0,0,0,0.06)] border-2 border-border/40 flex items-center justify-center relative transition-all duration-500 hover:border-accent-blue/40 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(var(--accent-blue-rgb,0,194,255),0.15)]">
                    ...
                    {/* Heart action icon */}
                    <div className="absolute bottom-4 right-4 opacity-0 scale-75 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 text-accent-blue bg-white/10 backdrop-blur-md p-2.5 rounded-full shadow-lg border border-accent-blue/20">
                  ...
                  <div className="flex flex-col gap-1 px-2">
                    <h3 className="text-lg font-bold text-foreground group-hover:text-accent-blue transition-colors drop-shadow-sm">{interest.name}</h3>
                    {interest.note && (
